...
public class SwingTimeTable extends JFrame {
...
//	}
	...
	public SwingTimeTable() {
		...
		JFrame G_time = new JFrame();
		G_time.setLayout(new GridLayout(1,4)); 
		...
		group.add(pass_chckbx100);
		
		JRadioButton pass_chckbx150 = new JRadioButton("150\uC2DC\uAC04");
		...
		group.add(pass_chckbx150);
		G_time.add(pass_chckbx150);
		
		JRadioButton period_chckbx1d = new JRadioButton("1\uC77C");
		...
		group.add(period_chckbx1d);
		G_time.add(period_chckbx1d);
		
		JRadioButton period_chckbx1w = new JRadioButton("1\uC8FC");
		...
		group.add(period_chckbx1w);
		G_time.add(period_chckbx1w);
		
		JRadioButton period_chckbx4w = new JRadioButton("4\uC8FC");
		...
		group.add(period_chckbx4w);
		G_time.add(period_chckbx4w);
		
		JRadioButton period_chckbx2w = new JRadioButton("2\uC8FC");
		...
		group.add(period_chckbx2w);
		G_time.add(period_chckbx2w);
		
		JRadioButton other_chckbxpersonal = new JRadioButton("\uAC1C\uC778\uB8F8");
		...
		group.add(other_chckbxpersonal);
		G_time.add(other_chckbxpersonal);
		
		JRadioButton other_chckbxmeeting = new JRadioButton("\uD68C\uC758\uB8F8");
		...
		group.add(other_chckbxmeeting);
		G_time.add(other_chckbxmeeting);
