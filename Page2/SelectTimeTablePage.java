...
public class SelectTimeTablePage extends JFrame {
	...
	private JPanel timetable_panel; //배경 테두리
	...
	private JCheckBox hours_chckbx2, hours_chckbx4, hours_chckbx6, hours_chckbx8; //당일 이용권 체크박스
	
	private JCheckBox pass_chckbx50, pass_chckbx100, pass_chckbx150; //정액권 체크박스
	
	private JCheckBox period_chckbx1d, period_chckbx1w, period_chckbx2w, period_chckbx4w;	//기간제 체크박스
	
	private JCheckBox other_chckbxpersonal, other_chckbxmeeting; //기타 체크박스
	
	private JButton btn_Price, btn_Chk;	// 가격표확인, 선택완료 버튼 
	...
	public final void init() {
		...
		timetable_title_text.setFont(new Font("굴림", Font.PLAIN, 20));
		...
		hourstitle_text.setFont(new Font("굴림", Font.PLAIN, 15));
		...
		passtitle_text.setFont(new Font("굴림", Font.PLAIN, 15));
		...
		periodtitle_text.setFont(new Font("굴림", Font.PLAIN, 15));
		...
		othertitle_text.setFont(new Font("굴림", Font.PLAIN, 15));
		...
		hours_chckbx6.setFont(new Font("굴림", Font.BOLD, 20));
		...
		hours_chckbx8.setFont(new Font("굴림", Font.BOLD, 20));
		...
		pass_chckbx50.setFont(new Font("굴림", Font.BOLD, 20));
		...
		pass_chckbx100.setFont(new Font("굴림", Font.BOLD, 20));
		...
		pass_chckbx150.setFont(new Font("굴림", Font.BOLD, 20));
		...
		period_chckbx1d.setFont(new Font("굴림", Font.BOLD, 20));
		...
		period_chckbx1w.setFont(new Font("굴림", Font.BOLD, 20));
		...
		period_chckbx2w.setFont(new Font("굴림", Font.BOLD, 20));
		...
		period_chckbx4w.setFont(new Font("굴림", Font.BOLD, 20));
		...
		other_chckbxpersonal.setFont(new Font("굴림", Font.BOLD, 20));
		...
		other_chckbxmeeting.setFont(new Font("굴림", Font.BOLD, 20));
		...
		chckbxNewCheckBox_1_1_1_2.setFont(new Font("굴림", Font.BOLD, 20));
