...
public class PricePage extends JFrame {
	...
	public PricePage() {	//ª˝º∫¿⁄
		...
		ImagePanel main_img_panel = new ImagePanel(new ImageIcon("./img/mainroom.png").getImage());
		
		File f = new File("./img/mainroom.png");		//¿ÃπÃ¡ˆ ∞Ê∑Œ »Æ¿Œ
		System.out.println(f.exists()?"Exist":"doesn't exits");
		...
		ImagePanel personal_img_panel = new ImagePanel(new ImageIcon("./img/personalroom.png").getImage());
		...
		ImagePanel meeting_img_panel = new ImagePanel(new ImageIcon("./img/meetingroom.png").getImage());
