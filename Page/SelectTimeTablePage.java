...
public class SelectTimeTablePage extends JFrame implements ItemListener {
   ...
   Font font_10 = new Font("Cafe24SsurroundAir", Font.BOLD, 12);
   ...
   public SelectTimeTablePage() {
     ...
     flower_img_panel.add(flowerimg);
      ...
      for (int i = 0; i < 4; i++) {
         ...
         // coupon_name_p[i].setBorder(new LineBorder (new Color(182,215,168), 30, true));
      ...
      String[] rdo_text = { "2시간", "4시간", "6시간", "8시간", "50시간", "100시간", "150시간", "1일", "1주", "2주", "4주", "회의룸",
            "개인실" };

      for (int i = 0; i < 13; i++) {
         radio_time[i] = new JRadioButton(rdo_text[i]);
         radio_time[i].setFont(font1);
      ...
      btn_Price.setBackground(new Color(0,0,0));
      ...
      btn_Chk.setBackground(new Color(0,0,0));
